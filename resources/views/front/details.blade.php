...
@section('content')
    <main
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div id="Contact" class="flex flex-col gap-2">
                                <div
                                    ...
                                    <a href="https://wa.me/{{ $carStore->phone_number }}"
        ...
        <div id="CTA-nav"
            ...
            @if ($carStore->is_open)
                @if ($carStore->is_full)
                    <a href="javascript:void(0)"
                        class="rounded-full p-[12px_20px] bg-[#EEEFF4] font-bold text-[#AAADBF]">Full
                        Booked</a>
                @else
            ...
            @else
                <a href="javascript:void(0)"
                    class="rounded-full p-[12px_20px] bg-[#EEEFF4] font-bold text-[#AAADBF]">Closed</a>
            @endif
